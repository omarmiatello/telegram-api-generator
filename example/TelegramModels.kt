...
// Getting updates
    ...
    data class DeleteWebhookRequest(
        ...
        override fun toJsonForRequest() = json.stringify(serializer(), this)
        override fun toJsonForResponse() = JsonObject(
            json.toJson(serializer(), this).jsonObject.content + ("method" to JsonLiteral("deleteWebhook"))
        ).toString()
...
// Available methods
    ...
    data class CopyMessageRequest(
        ...
        override fun toJsonForRequest() = json.stringify(serializer(), this)
        override fun toJsonForResponse() = JsonObject(
            json.toJson(serializer(), this).jsonObject.content + ("method" to JsonLiteral("copyMessage"))
        ).toString()
    ...
    data class SendMediaGroupRequest(
        val chat_id: String,
        val media: List<@ContextualSerialization InputMedia>,
        val disable_notification: Boolean? = null,
        val reply_to_message_id: Int? = null,
        val allow_sending_without_reply: Boolean? = null,
    ) : TelegramRequest() {
    ...
    data class SetChatAdministratorCustomTitleRequest(
        ...
        override fun toJsonForResponse() = JsonObject(
            json.toJson(
                serializer(),
                this
            ).jsonObject.content + ("method" to JsonLiteral("setChatAdministratorCustomTitle"))
        ).toString()
    ...
    data class CreateChatInviteLinkRequest(
        ...
        override fun toJsonForRequest() = json.stringify(serializer(), this)
        override fun toJsonForResponse() = JsonObject(
            json.toJson(serializer(), this).jsonObject.content + ("method" to JsonLiteral("createChatInviteLink"))
        ).toString()
    ...
    data class EditChatInviteLinkRequest(
        ...
        override fun toJsonForRequest() = json.stringify(serializer(), this)
        override fun toJsonForResponse() = JsonObject(
            json.toJson(serializer(), this).jsonObject.content + ("method" to JsonLiteral("editChatInviteLink"))
        ).toString()
    ...
    data class RevokeChatInviteLinkRequest(
        ...
        override fun toJsonForRequest() = json.stringify(serializer(), this)
        override fun toJsonForResponse() = JsonObject(
            json.toJson(serializer(), this).jsonObject.content + ("method" to JsonLiteral("revokeChatInviteLink"))
        ).toString()
    ...
    data class UnpinAllChatMessagesRequest(
        ...
        override fun toJsonForRequest() = json.stringify(serializer(), this)
        override fun toJsonForResponse() = JsonObject(
            json.toJson(serializer(), this).jsonObject.content + ("method" to JsonLiteral("unpinAllChatMessages"))
        ).toString()
